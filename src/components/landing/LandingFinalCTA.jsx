  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-5 py-20 lg:px-8">
      ...
      <motion.div
        ...
        className={isLight ? "relative overflow-hidden rounded-[2rem] border border-fuchsia-200 bg-gradient-to-br from-fuchsia-50 via-white to-purple-50 p-12 text-center shadow-[0_28px_90px_rgba(126,34,206,0.12)]" : "glass-card-vivid gradient-border glow-fuchsia relative overflow-hidden rounded-[2rem] p-12 text-center"}
      >
        ...
        <div className="relative z-10">
          <div className={isLight ? "mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-fuchsia-300 bg-fuchsia-50 px-4 py-2 text-xs font-black uppercase tracking-wider text-fuchsia-600" : "eyebrow-badge mx-auto mb-6 inline-flex"}>
          ...
          <p className={isLight ? "mx-auto mt-6 max-w-xl text-lg font-semibold leading-8 text-slate-600" : "mx-auto mt-6 max-w-xl text-lg font-semibold leading-8 text-zinc-400"}>
